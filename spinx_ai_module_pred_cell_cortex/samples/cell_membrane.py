...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 Custom.py train --dataset=/Users/daviddang/MASK_R-CNN_orig/Mask_RCNN/datasets/cell_membrane --weights=coco
...
COCO_WEIGHTS_PATH = "../spinx/Mask_RCNN/mask_rcnn_coco.h5"

# Directory to save logs and model checkpoints, if not provided
# through the command line argument --logs
DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "../spinx/Mask_RCNN/logs/")
...
class CustomDataset(utils.Dataset):
    ...
    def load_Custom(self, dataset_dir, subset):
        ...
        self.add_class("cell_membrane", 1, "cell_membrane")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "cell_membrane":
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect cell_membrane.')
